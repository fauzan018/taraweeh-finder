...
export default function RamadanCounter() {
  ...
  return (
    <div className="relative group">
      ...
      <div className="relative rounded-xl bg-white/8 backdrop-blur-xl border border-white/10 px-4 py-3 text-white font-semibold text-center mb-4 hover:border-white/20 hover:bg-white/12 transition-all duration-300">
        {day ? (
